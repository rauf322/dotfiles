...
vim.api.nvim_create_autocmd("BufWinEnter", {
  ...
  callback = function()
    ...
    vim.keymap.set("n", "<leader>cm", ":Git commit -m 'autocommit'<CR>", vim.tbl_extend("force", opts, { desc = "Fugitive: Auto Commit" }))

    vim.keymap.set("n", "<leader>t", ":Git push -u origin ", vim.tbl_extend("force", opts, { desc = "Fugitive: Git Push With Upstream" }))
  end,
})
